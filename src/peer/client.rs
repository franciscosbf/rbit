...
impl Message {
    ...
    pub(in crate::peer) fn encode(self, buff: &mut Vec<u8>) {
        match self {
...
impl PeerClient {
        ...
        E: PeerEvents,
    {
        ...
        if !accepted {
            ...
            return Err(PeerError::InvalidHandshake(peer_addr));
        }
        ...
        validate_spawn_receiver_with_8_pieces_and_69_of_buff_size(
            |_, _| {
                async move {
                    ...
                    assert_eq!(msg.index, 43);
                    assert_eq!(msg.begin, 23);
                    assert_eq!(msg.block, b"\xd9\x0c\x73\x24\x7c\xcb\xfc\xb6\x39\x95");
                }
                .boxed()
            },
            |mut writer| {
